...
const iconMap: Record<ActivityType, LucideIcon> = {
  ...
  [ActivityType.EMAIL_SIGN_IN]: UserCog,
  ...
  [ActivityType.LINK_GITHUB_ACCOUNT]: Link,
  [ActivityType.LINK_GOOGLE_ACCOUNT]: Link,
  [ActivityType.GITHUB_SIGN_IN]: UserCog,
  [ActivityType.GOOGLE_SIGN_IN]: UserCog,
};
...
function formatAction(action: ActivityType): string {
  switch (action) {
    case ActivityType.EMAIL_SIGN_UP:
      return "You signed up";
    case ActivityType.EMAIL_SIGN_IN:
